;PETSCII Robots Sprite Loader (X16 version)
...
;then it is executed at $8000 and copies the needed data
...
COPY_TO_VRAM:
	;COPY TO VRAM ADDRESS $E000 IN BANK 0
	LDA	#$E0
	STA	VERA_M
	LDA	#$00
	STA	VERA_L
